...
export default function WhyUs() {
  ...
  // Fixed email icon — simple envelope using rect+polyline, no bending on any screen
  const EmailIcon = () => (
    ...
    <div className="min-h-screen font-sans">
      ...
      <section className="relative py-28 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/images/whyusBg.jpg" alt="Why Us background" fill priority className="object-cover object-center" sizes="100vw" />
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {features.map((feature, index) => (
              <div key={index} className="bg-white rounded-3xl p-8 shadow-lg border border-[#80C531]/20 group hover:border-[#016837] transition-all duration-300 hover:shadow-xl">
                <div className="flex flex-col h-full">
                  <div className="w-16 h-16 bg-gradient-to-r from-[#016837] to-[#80C531] rounded-2xl flex items-center justify-center text-2xl text-white group-hover:scale-110 transition-transform duration-300 shadow-lg mb-6">{feature.icon}</div>
      ...
      <section className="py-24 bg-gradient-to-br from-green-600 to-green-800 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
            ...
            <Link href="/booking" className="bg-gradient-to-r from-[#80C531] to-[#9CD35A] hover:from-[#70B52B] hover:to-[#80C531] text-white font-bold py-4 px-8 rounded-lg flex items-center justify-center gap-3 group text-lg transition-all duration-300 shadow-lg hover:shadow-xl">
              <span>Book Your EPC</span>
              <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>
            </Link>
          </div>

          {/* Contact Info — fixed email icon */}

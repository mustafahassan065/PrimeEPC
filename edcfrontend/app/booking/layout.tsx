...
export const metadata: Metadata = {
  ...
  description:
    'Book accredited domestic EPCs (from £50), commercial EPCs (from £144), and landlord EICR safety reports (£110) online. 24-48h turnaround across Greater Manchester.',
  keywords: [
    'Book EPC Manchester',
  ...
  twitter: {
    ...
    description:
      'Book domestic EPCs from £50, commercial EPCs from £144, and EICR reports from £110 across Greater Manchester.',
  },
}

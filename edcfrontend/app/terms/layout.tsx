...
export const metadata: Metadata = {
  title: 'Terms & Conditions | Prime EPC & Design Consultants Greater Manchester',
  description: 'Terms of service, policies, and booking terms for Prime EPC & Design Consultant Ltd across Greater Manchester.',
  keywords: ['Prime EPC Terms', 'EPC Service Agreement Greater Manchester', 'Terms and Conditions'],

...
router.post('/send-booking-confirmation', async (req, res) => {
  try {
    ...
    const dateStr = dateObj
      ? dateObj.toLocaleDateString('en-GB', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric', timeZone: 'UTC' })
      : 'Not specified'
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;max-width:600px;width:100%;">
  ...
  <!-- HEADER -->
  <tr><td style="background:#016837;padding:20px 28px;">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td style="vertical-align:middle;width:80px;">
        <img src="` + LOGO + `" width="72" height="72" alt="Prime EPC Logo" style="display:block;border-radius:8px;" />
      </td>
      <td style="padding-left:16px;vertical-align:middle;">
        <p style="margin:0;font-size:20px;font-weight:900;color:#ffffff;letter-spacing:1px;text-transform:uppercase;">PRIME EPC</p>
        <p style="margin:2px 0 0;font-size:10px;font-weight:700;color:#80C531;letter-spacing:2px;text-transform:uppercase;">&amp; Design Consultants</p>
      </td>
      <td style="border-left:1px solid rgba(255,255,255,0.25);padding-left:20px;vertical-align:middle;" align="right">
        <p style="margin:0;font-size:12px;color:rgba(255,255,255,0.85);line-height:1.8;">Your Property.<br>Our Expertise.<br><span style="color:#80C531;font-style:italic;font-weight:600;">A Greener Tomorrow.</span></p>
      </td>
    </tr></table>
  </td></tr>
  ...
  <tr><td style="padding:32px 28px 20px;">
    ...
    <p style="margin:20px 0 4px;color:#374151;font-size:14px;">Hi <strong>${name}</strong>,</p>
    <p style="margin:0 0 4px;font-size:14px;color:#111827;"><strong>Thank you for choosing Prime EPC &amp; Design Consultants.</strong></p>
    <p style="margin:4px 0 0;font-size:13px;color:#6b7280;">Your appointment has been successfully confirmed.</p>
    <p style="margin:8px 0 0;font-size:13px;color:#6b7280;">We look forward to visiting your property and helping you with your EPC assessment.</p>
  </td></tr>

  <!-- BOOKING DETAILS CARD -->
  <tr><td style="padding:0 28px 24px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#f0fdf4;border:1px solid #d1fae5;border-radius:10px;overflow:hidden;">
      <!-- Card header -->
      <tr><td style="padding:14px 20px;border-bottom:2px solid #016837;">
        <table cellpadding="0" cellspacing="0"><tr>
          <td style="width:34px;height:34px;background:#016837;border-radius:6px;text-align:center;vertical-align:middle;">
            <span style="color:white;font-size:18px;">📋</span>
          </td>
          <td style="padding-left:10px;font-size:13px;font-weight:800;color:#016837;text-transform:uppercase;letter-spacing:0.5px;">Booking Details</td>
        </tr></table>
      </td></tr>
      <!-- Service -->
      <tr><td style="padding:14px 20px;border-bottom:1px solid #d1fae5;background:#ffffff;">
        <table cellpadding="0" cellspacing="0"><tr>
          <td style="width:38px;height:38px;background:#e8f5e9;border-radius:50%;text-align:center;vertical-align:middle;"><span style="font-size:18px;">🔧</span></td>
          <td style="padding-left:14px;"><p style="margin:0;font-size:11px;color:#6b7280;text-transform:uppercase;letter-spacing:0.3px;">Service</p><p style="margin:3px 0 0;font-size:15px;font-weight:700;color:#111827;">${service}</p></td>
        </tr></table>
      </td></tr>
      <!-- Address -->
      <tr><td style="padding:14px 20px;border-bottom:1px solid #d1fae5;background:#ffffff;">
        <table cellpadding="0" cellspacing="0"><tr>
          <td style="width:38px;height:38px;background:#e8f5e9;border-radius:50%;text-align:center;vertical-align:middle;"><span style="font-size:18px;">🏠</span></td>
          <td style="padding-left:14px;"><p style="margin:0;font-size:11px;color:#6b7280;text-transform:uppercase;letter-spacing:0.3px;">Property Address</p><p style="margin:3px 0 0;font-size:15px;font-weight:700;color:#111827;">${propertyAddress}, ${postcode}</p></td>
        </tr></table>
      </td></tr>
      <!-- Date -->
      <tr><td style="padding:14px 20px;border-bottom:1px solid #d1fae5;background:#ffffff;">
        <table cellpadding="0" cellspacing="0"><tr>
          <td style="width:38px;height:38px;background:#e8f5e9;border-radius:50%;text-align:center;vertical-align:middle;"><span style="font-size:18px;">📅</span></td>
          <td style="padding-left:14px;"><p style="margin:0;font-size:11px;color:#6b7280;text-transform:uppercase;letter-spacing:0.3px;">Date</p><p style="margin:3px 0 0;font-size:15px;font-weight:700;color:#111827;">${dateStr}</p></td>
        </tr></table>
      </td></tr>
      <!-- Time -->
      <tr><td style="padding:14px 20px;background:#ffffff;">
        <table cellpadding="0" cellspacing="0"><tr>
          <td style="width:38px;height:38px;background:#e8f5e9;border-radius:50%;text-align:center;vertical-align:middle;"><span style="font-size:18px;">🕐</span></td>
          <td style="padding-left:14px;"><p style="margin:0;font-size:11px;color:#6b7280;text-transform:uppercase;letter-spacing:0.3px;">Time</p><p style="margin:3px 0 0;font-size:15px;font-weight:700;color:#111827;">${timeStr}</p></td>
        </tr></table>
      </td></tr>
    </table>
  </td></tr>
  ...
  <tr><td style="padding:0 28px 24px;" align="center">
    <a href="https://www.primeepcdesign.co.uk/booking" style="display:inline-block;background:#016837;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;padding:16px 32px;border-radius:30px;letter-spacing:0.3px;">
  ...
  <tr><td style="padding:0 28px 28px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fffe;border-left:4px solid #016837;border-radius:0 8px 8px 0;padding:14px 18px;">
      <tr><td>
        <table cellpadding="0" cellspacing="0"><tr>
          <td style="font-size:22px;vertical-align:middle;">🌿</td>
          <td style="padding-left:12px;vertical-align:middle;">
            <p style="margin:0;font-size:13px;font-weight:700;color:#111827;">Need to make changes?</p>
            <p style="margin:3px 0 0;font-size:12px;color:#6b7280;">Just reply to this email or get in touch with our team.</p>
          </td>
        </tr></table>
      </td></tr>
    </table>
  ...
  <!-- FOOTER TRUST BAR -->
  <tr><td style="background:#014d28;padding:20px 28px;">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td style="text-align:center;padding:0 6px;border-right:1px solid rgba(255,255,255,0.15);">
        <p style="margin:0;font-size:20px;">🛡️</p>
        <p style="margin:5px 0 2px;font-size:10px;color:#80C531;font-weight:700;">Trusted Experts</p>
        <p style="margin:0;font-size:9px;color:rgba(255,255,255,0.5);">Accurate &amp; Compliant</p>
      </td>
      <td style="text-align:center;padding:0 6px;border-right:1px solid rgba(255,255,255,0.15);">
        <p style="margin:0;font-size:20px;">🌿</p>
        <p style="margin:5px 0 2px;font-size:10px;color:#80C531;font-weight:700;">Energy Efficient</p>
        <p style="margin:0;font-size:9px;color:rgba(255,255,255,0.5);">A Greener Future</p>
      </td>
      <td style="text-align:center;padding:0 6px;border-right:1px solid rgba(255,255,255,0.15);">
        <p style="margin:0;font-size:20px;">🏠</p>
        <p style="margin:5px 0 2px;font-size:10px;color:#80C531;font-weight:700;">Local Service</p>
        <p style="margin:0;font-size:9px;color:rgba(255,255,255,0.5);">Bolton &amp; Surrounding Areas</p>
      </td>
      <td style="text-align:center;padding:0 6px;">
        <img src="` + LOGO + `" width="44" height="44" alt="Prime EPC" style="display:block;margin:0 auto;border-radius:6px;" />
        <p style="margin:5px 0 2px;font-size:10px;color:#80C531;font-weight:700;">PRIME EPC</p>
        <p style="margin:0;font-size:8px;color:rgba(255,255,255,0.5);">&amp; Design Consultants</p>
      </td>
    </tr></table>
  </td></tr>
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;max-width:600px;width:100%;">
  ...
  <!-- HEADER -->
  <tr><td style="background:#016837;padding:16px 28px;">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td style="vertical-align:middle;width:64px;">
        <img src="` + LOGO + `" width="56" height="56" alt="Prime EPC Logo" style="display:block;border-radius:8px;" />
      </td>
      <td style="padding-left:14px;vertical-align:middle;">
        <p style="margin:0;font-size:17px;font-weight:900;color:#ffffff;text-transform:uppercase;letter-spacing:1px;">PRIME EPC</p>
        <p style="margin:2px 0 0;font-size:9px;color:#80C531;letter-spacing:2px;text-transform:uppercase;">&amp; Design Consultants</p>
      </td>
  ...
  <!-- NEW BOOKING BANNER -->
  <tr><td style="background:#014d28;padding:16px 28px;">
    <table cellpadding="0" cellspacing="0"><tr>
      <td style="width:42px;height:42px;background:rgba(255,255,255,0.15);border-radius:8px;text-align:center;vertical-align:middle;font-size:20px;">📅</td>
  ...
  <tr><td style="padding:20px 28px;">
    <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
      <tr><td colspan="2" style="background:#f9fafb;padding:10px 16px;border-bottom:1px solid #e5e7eb;">
        <p style="margin:0;font-size:11px;font-weight:700;color:#016837;text-transform:uppercase;letter-spacing:0.5px;">Customer Information</p>
      </td></tr>
      ${[
        ['👤','Name', name],
        ['✉️','Email', email],
      ...
      <tr style="border-bottom:1px solid #f3f4f6;">
        <td style="padding:10px 16px;width:36%;color:#6b7280;font-size:12px;">${icon} ${label}</td>
        <td style="padding:10px 16px;color:#111827;font-weight:600;font-size:12px;">${val || 'N/A'}</td>
      </tr>`).join('')}
    </table>

    <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:14px;background:#f0fdf4;border-left:4px solid #016837;border-radius:0 8px 8px 0;padding:14px 18px;">
      <tr><td>
        <p style="margin:0;font-size:12px;font-weight:700;color:#016837;">🛡️ Please confirm with the customer</p>
  ...
  <!-- FOOTER -->
  <tr><td style="background:#014d28;padding:14px 28px;">
    <p style="margin:0;font-size:11px;color:rgba(255,255,255,0.5);">📞 07308 658247 &nbsp;|&nbsp; ✉️ info@primeepcdesign.co.uk &nbsp;|&nbsp; Prime EPC &amp; Design Consultant Ltd</p>
  </td></tr>
